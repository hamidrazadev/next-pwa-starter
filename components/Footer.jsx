        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="flex space-x-3 pt-2">
              <Link href="https://hamidrazadev.vercel.app" className="w-10 h-10 bg-gray-800/50 hover:bg-orange-500 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-gray-500/25 group">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="https://hamidrazadev.vercel.app"
                  target="_blank"
                  rel="noopener noreferrer"
