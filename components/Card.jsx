export default function Card({
  ...
  const variants = {
    default: "bg-linear-to-br from-gray-900 to-black border-gray-800/50 text-white shadow-lg shadow-black/20 hover:shadow-xl hover:shadow-blue-500/10 hover:border-gray-700/70",
    elevated: "bg-linear-to-br from-gray-800 to-gray-900 border-gray-700/50 text-white shadow-xl shadow-black/40 hover:shadow-2xl hover:shadow-blue-500/20 hover:border-gray-600/70 hover:-translate-y-1",
  ...
  return (
    <div className={cardClasses} {...props}>
      ...
      <div className="absolute inset-0 bg-linear-to-r from-blue-500/0 via-blue-500/5 to-blue-500/0 translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-1000 ease-out" />
      ...
      {/* Corner accent */}
      <div className="absolute top-0 right-0 w-20 h-20 bg-linear-to-br from-blue-500/10 to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
    </div>
  )
}