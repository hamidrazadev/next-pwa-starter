...
export default function NotFoundPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white relative overflow-hidden flex items-center justify-center">
            {/* Animated Background */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-900/20 via-black to-purple-950/20">
            ...
            <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl">
                ...
                <div className="mb-8 relative">
                    <div className={`text-8xl md:text-9xl font-black mb-4 transition-all duration-200 ${glitchEffect
                            ...
                            : 'bg-gradient-to-r from-blue-400 via-purple-400 to-blue-600 bg-clip-text text-transparent'
                        }`}>
                        404
                    </div>
                    ...
                    {/* Animated underline */}
                    <div className="mx-auto w-32 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full animate-pulse"></div>
                </div>
                ...
                <div className="mb-8">
                    <div className="relative inline-block">
                        <div className="w-24 h-24 bg-gradient-to-br from-blue-500/20 to-purple-500/30 rounded-full flex items-center justify-center backdrop-blur-sm border border-blue-500/30 shadow-2xl shadow-blue-500/20 animate-bounce">
                ...
                {/* Footer Message */}
                <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 max-w-2xl mx-auto">
