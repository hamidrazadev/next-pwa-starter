...
import { Wifi, WifiOff, RefreshCw, Globe, Smartphone, Router, AlertCircle, CheckCircle, Clock } from "lucide-react"
...
export default function OfflinePage() {
    ...
    const handleRetry = async () => {
        ...
        // In a real app, you would check navigator.onLine or try to fetch a resource
        // For demo purposes, we'll just show the retry happened
    }
    ...
    const troubleshootingTips = [
        {
            ...
            description: "Make sure your router is powered on and all cables are connected properly."
        },
        {
            icon: Wifi,
            title: "WiFi Connection",
            description: "Try disconnecting and reconnecting to your WiFi network."
        },
        {
            icon: Smartphone,
            title: "Mobile Data",
            description: "If using WiFi, try switching to mobile data or vice versa."
        },
        {
            icon: Globe,
            title: "Website Status",
            description: "The website might be temporarily down. Try again in a few minutes."
        }
    ]

    const quickActions = [
        { label: "Refresh Page", action: () => window.location.reload(), variant: "primary" },
        { label: "Go Back", action: () => window.history.back(), variant: "outline" },
        { label: "Home Page", action: () => window.location.href = "/", variant: "ghost" }
    ]
    ...
    return (
        <div className="min-h-screen bg-black text-white relative overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgba(239,68,68,0.1)_1px,transparent_0)] bg-[length:50px_50px] opacity-30"></div>
